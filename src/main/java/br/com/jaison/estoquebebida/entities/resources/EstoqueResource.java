...
public class EstoqueResource {
	...
	public List<Estoque> consultaBebidasArmazenadasPorSecao(@PathVariable Integer numeroSecao) throws NotFoundSecaoException {
		return this.service.getBebidasArmazenadasPorSecao(numeroSecao);
	}
	...
	public Historico consultaBebidasArmazenadasPorSecao(@PathVariable Integer numeroSecao, @RequestBody Historico operacaoHistoricoEstoque)
			throws RegraDeNegocioValidationException, NotFoundObjectException {
		return this.serviceHistorico.executaOperacaoEstoque(operacaoHistoricoEstoque, numeroSecao);
	...
	public List<Estoque> consultaLocalDisponivelPorVolume(@RequestParam("volume") Double volume, @PathVariable Integer tipoBebida)
			throws NotFoundObjectException {
		return this.service.consultaLocalDisponivelPorVolume(volume, tipoBebida);
	...
	public List<Estoque> consultaLocalDisponivelPorVolume(@PathVariable Integer tipoBebida) throws NotFoundTypeBebidaException {
		return this.service.getAllSecoesByTipoBebida(tipoBebida);
	...
	public Double consultaSecoesByTipoBebida(@PathVariable Integer tipoBebida) throws NotFoundTypeBebidaException {
		return this.service.consultaVolumeTotalEstoquePortipo(tipoBebida);
	}
